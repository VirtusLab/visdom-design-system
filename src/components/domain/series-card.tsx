  ...
  return (
    ...
    >
      ...
      <a
        ...
        target="_blank"
        rel="noopener"
        className="block rounded-lg bg-muted border border-border p-4 mb-4 hover:border-primary/30 transition-colors group"
      >
      ...
      <div className="flex-1 space-y-0">
        {articles.map((article, i) => (
          <a
            ...
            target="_blank"
            rel="noopener"
            className="flex justify-between items-baseline py-2.5 border-b border-border text-sm text-muted-foreground hover:text-primary transition-colors"
          >
